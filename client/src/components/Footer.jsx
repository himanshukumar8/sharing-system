  ...
  return (
    <footer className="w-full border-t border-gray-300 shadow-inner bg-[var(--bg-color)] text-[var(--text-color)] py-6 px-4 flex flex-col md:flex-row items-center justify-between">
      <p className="text-center text-sm font-medium">
         <span className="font-semibold">© 2026 Himanshu Kumar</span>
      </p>

      <div className="flex items-center gap-4 mt-4 md:mt-0">
        {/* LinkedIn */}
        <a
          href="https://www.linkedin.com/in/himanshuhhk/"
          target="_blank"
        ...
        {/* GitHub */}
        <a
          href="https://github.com/himanshukumar8"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:scale-110 transition-transform"
        >
        ...
        {/* Instagram */}
        <a
          href="https://www.instagram.com/himanshu.hhk/"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:scale-110 transition-transform"
        >
        ...
        {/* Email */}
        <a
          href="mailto:himanshuhhkumar@gmail.com"
          className="hover:scale-110 transition-transform"
        >
          <img
