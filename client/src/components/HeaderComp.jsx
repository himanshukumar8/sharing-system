    ...
    <>
      ...
      <header className="w-full sm:hidden flex items-center justify-between px-4 py-3 border-b shadow-sm fixed top-0 left-0 z-50 bg-[var(--bg-color)] text-[var(--text-color)]">
        <Link to="/" className="flex items-center space-x-2">
          ...
          <span className="text-xl font-bold text-[var(--primary-text)]">SharingSystem</span>
        </Link>
      ...
      <div className="hidden sm:flex flex-col text-center">
              <Link to="/" className="flex items-center space-x-2">
                <img src={logo} alt="Logo" className="w-10 h-10" />
                <span className="text-3xl font-bold text-[var(--primary-text)]">SharingSystem</span>
              </Link>
              <span className="text-base text-[var(--secondary-text)]">Quickly share files anonymously</span>
            </div>
